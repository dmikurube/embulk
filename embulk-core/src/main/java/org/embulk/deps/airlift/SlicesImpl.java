...
// The class must be public to be instantiated through Constructor#newInstance from ImplLoader.
public class SlicesImpl extends org.embulk.deps.airlift.Slices {
