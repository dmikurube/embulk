        ...
        implements ParserPlugin
{
    ...
    public enum QuotesInQuotedFields
    {
        ...
        ACCEPT_STRAY_QUOTES_AS_IS_ASSUMING_NO_DELIMITERS_IN_FIELDS,
        ;
        ...
        public static QuotesInQuotedFields ofString(final String string)
        {
            ...
            throw new ConfigException("\"quotes_in_quoted_fields\" must be one of [ACCEPT_ONLY_RFC4180_ESCAPED, ACCEPT_STRAY_QUOTES_AS_IS_ASSUMING_NO_DELIMITERS_IN_FIELDS].");
        }
    }
