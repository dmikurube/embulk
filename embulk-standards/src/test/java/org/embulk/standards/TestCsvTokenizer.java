...
public class TestCsvTokenizer
{
    ...
    @Test
    public void parseWithQuotesInQuotedFields_ACCEPT_STRAY_QUOTES_AS_IS_ASSUMING_NO_DELIMITERS_IN_FIELDS() throws Exception
    {
        config.set("quotes_in_quoted_fields", "ACCEPT_STRAY_QUOTES_AS_IS_ASSUMING_NO_DELIMITERS_IN_FIELDS");
        reloadPluginTask();
        assertEquals(expectedRecords(
                         2,
                         "foo\"bar", "foofoo\"barbar",
